# BinMatch - versão comentada com relatórios e validações
...
st.set_page_config(
    page_title="BinMatch",
    page_icon="https://raw.githubusercontent.com/MySpaceCrazy/BinMatch/refs/heads/main/Imagens/CP-6423-01.ico",
    layout="wide"
)
...
st.markdown(
    ...
    <div style="display: flex; align-items: center;">
        <img src="https://raw.githubusercontent.com/MySpaceCrazy/BinMatch/refs/heads/main/Imagens/CP-6423-01.ico" width="80" style="margin-right: 15px;">
...
<div class="author">
    ...
    <div style="margin: 10px 0;">
        <a href="https://github.com/MySpaceCrazy" target="_blank">
            <img src="https://raw.githubusercontent.com/MySpaceCrazy/BinMatch/refs/heads/main/Imagens/github.ico" alt="GitHub" style="width: 32px; height: 32px; margin-right: 10px;">
        </a>
        <a href="https://www.linkedin.com/in/%C3%A2nderson-matheus-flores-de-oliveira-5b92781b4" target="_blank">
            <img src="https://raw.githubusercontent.com/MySpaceCrazy/BinMatch/refs/heads/main/Imagens/linkedin.ico" alt="LinkedIn" style="width: 32px; height: 32px;">
        </a>
    </div>
